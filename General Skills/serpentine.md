...
````
cowboyofnoname-picoctf@webshell:~$ cat serpentine.py 
...
cowboyofnoname-picoctf@webshell:~$ python3 serpentine.py 
...
cowboyofnoname-picoctf@webshell:~$ nano serpentine.py 
cowboyofnoname-picoctf@webshell:~$ python3 serpentine.py 
picoCTF{7h3_r04d_l355_7r4v3l3d_8e47d128}
`````
## Notas
